...
/*********************************************************
 * TODO: Merge this with children-list make this more componentized
 * only difference is the case load prefix on the collect, and no createChild
 *********************************************************/
...
class CaseLoad extends React.Component {
  collection() { 
    ...
    if (!state.children) {
      Child.collection('/case_load').then(function(result) {
            ...
            <div className='col-md-6'>
              ...
              <button type="button" onClick={this.createModal.bind(this)}
                ...
                <button type="button" onClick={this.createModal.bind(this)}
                 ...
                 <button type="button" onClick={this.createModal.bind(this)}
                   className="btn btn-secondary">Assign Child <i className='fa fa-child'></i></button>
           
              </div>

            </div>
            <Search additionalUrlPiece='case_load' className="col-md-4" model={Child} searchCallback={this.searchCallback.bind(this)} />
